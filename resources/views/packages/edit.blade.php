...
<head>
    ...
    <title>Edit Package - Photo Platform</title>
    ...
    <div class="min-h-screen">
        ...
        <main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                <div class="mb-6">
                    <h2 class="text-2xl font-bold text-gray-900">Edit Package</h2>
                    <p class="mt-2 text-gray-600">Update package details</p>
                </div>
                ...
                <form method="POST" action="{{ route('packages.update', $package) }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" id="photo_count" name="photo_count" min="1" max="1000" value="{{ old('photo_count', $package->photo_count) }}" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>

                    <div class="mb-6">
                        <label class="flex items-center">
                            <input type="checkbox" name="includes_digital" value="1" {{ old('includes_digital', $package->includes_digital) ? 'checked' : '' }} class="mr-3">
                    ...
                    <div class="mb-6">
                        <label class="flex items-center">
                            <input type="checkbox" name="includes_prints" value="1" {{ old('includes_prints', $package->includes_prints) ? 'checked' : '' }} class="mr-3">
                    ...
                    <div class="mb-6">
                        <label class="flex items-center">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $package->is_active) ? 'checked' : '' }} class="mr-3">
